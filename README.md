...
- nomplex/src/Components/Header.tsx
...
transition={{ type: 'linear' }} 으로 동작이 안돼서

transition={{ ease: 'linear' }} 으로 수정 하니 정상 동작 합니다.
...
- animation을 attribute가 아닌 코드로 실행할 수 있음!!!
- useAnimation()
  - https://www.framer.com/motion/use-animation-controls/
...
"useViewportScroll" 은 "useScroll" 로 변경되었습니다!
